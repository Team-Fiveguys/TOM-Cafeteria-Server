...
import fiveguys.Tom.Cafeteria.Server.cafeteria.presentation.converter.DietPhotoConverter;
...
import fiveguys.Tom.Cafeteria.Server.cafeteria.service.CafeteriaCommandService;
...
import fiveguys.Tom.Cafeteria.Server.cafeteria.presentation.dto.request.DietRequestDTO;
...
import fiveguys.Tom.Cafeteria.Server.cafeteria.presentation.converter.MenuConverter;
...
public class AdminCafeteriaController {
    ...
    public ApiResponse<DietPhotoResponseDTO.DietPhotoUploadDTO> uploadDietPhoto(
        ...
        DietPhoto dietPhoto = cafeteriaCommandService.uploadDietPhoto(cafeteriaId, date, meals, multipartFile);
    ...
    public ApiResponse<DietPhotoResponseDTO.DietPhotoUploadDTO> updateDietPhoto(
        ...
        DietPhoto dietPhoto = cafeteriaCommandService.reuploadDietPhoto(cafeteriaId, date, meals, multipartFile);
        return ApiResponse.onSuccess(DietPhotoConverter.toDietPhotoUploadDTO(dietPhoto));
    }
}
